  ...
  return (
    <React.Fragment>
      ...
      <article className="articlemybookings">
        ...
        <div  className='Headingtop'>Your Bookings
        </div>
        ...
        <div className='divforbookingslots' style={{ justifyContent: 'center'}}>
             ...
             <div  className='individual_booking_container' >
                 ...
                 <div style={{marginTop: 10, paddingTop: 15}} clssName='divsystemname'>
                     ...
                     <p style={{textAlign: 'left',fontSize: 20,color: 'black'}}>&nbsp;<FontAwesomeIcon icon={faDesktop} color='black' />    Booking System number 1
                     </p>
